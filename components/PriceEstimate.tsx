  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
      ...
      <div className="p-6">
        {/* Location Score */}
        <div
          className={`${getScoreBg(estimate.locationScore)} border rounded-xl p-4 mb-6 flex items-center justify-between`}
        >
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              بناءً على الخدمات والأنشطة المحيطة
            </p>
          </div>
          <div
            className={`text-3xl font-bold ${getScoreColor(estimate.locationScore)}`}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gradient-to-bl from-blue-50 to-white border border-blue-100 rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-blue-700">
              {formatNumber(estimate.pricePerSqmSale)}
            </p>
          ...
          <div className="bg-gradient-to-bl from-green-50 to-white border border-green-100 rounded-xl p-4">
            <p className="text-sm text-gray-600 mb-1">
              الإيجار الشهري (شقة 150م²)
            </p>
            <p className="text-2xl font-bold text-green-700">
              {formatNumber(estimate.monthlyRent)}
            </p>
            ...
            <div className="flex items-center gap-4">
              <div className="text-center flex-1">
                ...
                <p className="text-lg font-semibold text-gray-700">
                  {formatNumber(estimate.priceRangeMin)}
                </p>
              </div>
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-lg font-semibold text-gray-700">
                  {formatNumber(estimate.priceRangeMax)}
                </p>
              </div>
            </div>
        ...
        <div className="mt-6 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3">
          <p className="text-xs text-amber-700">
            تنبيه: هذه تقديرات تقريبية مبنية على بيانات محاكاة وليست أسعاراً فعلية.
            للحصول على تقييم دقيق، يرجى الاستعانة بمقيّم عقاري معتمد.
          </p>
        </div>
      </div>
    </div>
